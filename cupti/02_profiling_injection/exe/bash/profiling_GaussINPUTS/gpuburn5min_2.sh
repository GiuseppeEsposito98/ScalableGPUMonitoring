...
env CUDA_INJECTION64_PATH=./libinjection.so ./test-apps/gpu-burnGauss/gpu_burn -i 0 -c ./test-apps/gpu-burnGauss/compare.ptx -m 50% > data/raw/GaussINPUTS/gpuburn5min2_$INJECTION_KERNEL_COUNT.txt 300 2 1