...
while [ "$(date +%s)" -lt "$end_time" ]; do
    ...
    env CUDA_INJECTION64_PATH=./libinjection.so ./test-apps/gpu-rodinia/bin/linux/cuda/hotspot 1024 5 5 ./test-apps/gpu-rodinia/hotspot/temp_1024 ./test-apps/gpu-rodinia/hotspot/power_1024 log.log  >> data/raw/stress2/hotspot_${INJECTION_KERNEL_COUNT}r${run}.txt &
    app_pid=$!
