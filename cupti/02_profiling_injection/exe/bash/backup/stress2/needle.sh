...
while [ "$(date +%s)" -lt "$end_time" ]; do
    ...
    env CUDA_INJECTION64_PATH=./libinjection.so ./test-apps/gpu-rodinia/bin/linux/cuda/needle 1024 5  >> data/raw/stress2/needle_${INJECTION_KERNEL_COUNT}r${run}.txt &
    app_pid=$!
