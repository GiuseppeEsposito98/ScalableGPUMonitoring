...
while [ "$(date +%s)" -lt "$end_time" ]; do
    ...
    env CUDA_INJECTION64_PATH=./libinjection.so ./test-apps/gpu-rodinia/bin/linux/cuda/sc_gpu 0 15 7 60000 64 1000 null log.log 32 >> data/raw/stress2/scgpu_${INJECTION_KERNEL_COUNT}r${run}.txt &
    app_pid=$!
