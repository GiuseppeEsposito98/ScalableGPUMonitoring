...
env CUDA_INJECTION64_PATH=./libinjection.so ./test-apps/gpu-burn/gpu_burn -i 0 -c ./test-apps/gpu-burn/compare.ptx -m 50% > data/raw/stress2/gpuburn5min_${INJECTION_KERNEL_COUNT}r${run}.txt 300