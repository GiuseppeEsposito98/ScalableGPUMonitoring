...
env CUDA_INJECTION64_PATH=./libinjection.so ./test-apps/gpu-rodinia/bin/linux/cuda/srad_v2 2048 2048 50 60 50 60 0.5 20 > data/raw/srad_$INJECTION_KERNEL_COUNT.txt
