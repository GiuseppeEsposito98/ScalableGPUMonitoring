...
./libpc_sampling_continuous.pl --collection-mode 1 --sampling-period 25 --file-name 25kernels_backprop.dat --app "./test-apps/gpu-rodinia/bin/linux/cuda/backprop 65536"

export LD_LIBRARY_PATH="/home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/01_pc_sampling_continuous/":"/usr/local/cuda-12/lib64"
./libpc_sampling_continuous.pl --collection-mode 1 --sampling-period 25 --file-name 25kernels_gaussian.dat --circular-buf-count 390 --app "./test-apps/gpu-rodinia/bin/linux/cuda/gaussian -f ./test-apps/gpu-rodinia/gaussian/matrix1024.txt"

export LD_LIBRARY_PATH="/home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/01_pc_sampling_continuous/":"/usr/local/cuda-12/lib64"
./libpc_sampling_continuous.pl --collection-mode 1 --sampling-period 25 --file-name 25kernels_sc_gpu.dat --app "./test-apps/gpu-rodinia/bin/linux/cuda/sc_gpu 0 10 256 1024 32 32 null out.txt 128"
