...
# export LD_LIBRARY_PATH="/home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/01_pc_sampling_continuous/":"/usr/local/cuda-12/lib64"
# ./libpc_sampling_continuous.pl --collection-mode 2 --sampling-period 20 --file-name 20kernels_gpuburn.dat --app "./test-apps/gpu-burn/gpu_burn 60"
...
# mv 20kernels_gpuburn.dat data/raw/Parallel/20_gpuburn.dat