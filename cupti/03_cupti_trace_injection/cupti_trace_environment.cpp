...
SelectActivities()
{
    SELECT_ACTIVITY(injectionGlobals.profileMode, CUPTI_ACTIVITY_KIND_ENVIRONMENT);
    // SELECT_ACTIVITY(injectionGlobals.profileMode, CUPTI_ACTIVITY_ENVIRONMENT_POWER);
    // SELECT_ACTIVITY(injectionGlobals.profileMode, CUPTI_ACTIVITY_ENVIRONMENT_COOLING);
    // SELECT_ACTIVITY(injectionGlobals.profileMode, CUPTI_ACTIVITY_ENVIRONMENT_COOLING);
    ...
    // SELECT_ACTIVITY(injectionGlobals.profileMode, CUPTI_ACTIVITY_KIND_CUDA_EVENT);
