...
ncu --csv --force-overwrite --log-file data/raw/stress/NN50Percmnasnet05_1.csv \
...
ncu --csv --log-file data/raw/ncu/NN50Percmnasnet05sass_1.csv --print-source sass --page source --force-overwrite \
        --target-processes all --replay-mode kernel --kernel-name-base function --launch-skip-before-match 0 \
